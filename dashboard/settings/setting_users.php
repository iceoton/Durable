<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-user fa-fw"></i>ผู้ดูแลระบบ</h1>
    </div>
</div>
<ol class="breadcrumb">
...
<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"><i
        class="fa fa-plus fa-fw"></i>เพิ่มผู้ดูแลระบบ</button>
<br/><br/>
<?php
                ...
                while ($showalluser = mysql_fetch_object($getalluser)) {
                    ...
                    <tr id="<?php echo @$showalluser->user_key; ?>">
                        ...
                        <td align="center"> <?php
                            ...
                            ?><a href="?p=setting_users&e=y&key=<?php echo @$showalluser->user_key; ?>"
            ...
            <table width="100%" border="0" class="table table-bordered table-hover">
                ...
                while ($showalluser = mysql_fetch_object($getalluser)) {
                    ...
                    <tr id="<?php echo @$showalluser->user_key; ?>">
                        ...
                        <td align="center">
                            <div class="box_img_cycle3"><img
                                    src="../resource/members/thumbs/<?php echo @$showalluser->user_photo; ?>" <?php echo getPhotoSize('../resource/members/thumbs/' . @$showalluser->user_photo . ''); ?>
                                    id="img_cycle3" alt=""/></div>
                        </td>
                        <td>&nbsp;<span style="font-size:12px; <?php echo $color; ?>"><i class="fa fa-circle fa-fw"></i></span>&nbsp;<?php echo @$showalluser->name . "&nbsp;&nbsp;&nbsp;" . $showalluser->lastname; ?>
                        </td>
