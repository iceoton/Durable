<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-wrench fa-fw"></i> <?php echo "รายงานการส่งซ่อมครุภัณฑ์"; ?></h1>
    </div>
</div>
<ol class="breadcrumb">
    <li><a href="index.php"><?php echo @LA_MN_HOME; ?></a></li>
    <li><a href="?p=report"><?php echo "รายงานครุภัณฑ์"; ?></a></li>
    <li class="active"><?php echo "รายงานการส่งซ่อมครุภัณฑ์"; ?></li>
</ol>

<?php
$manageType = 4;
$exportFileName = "รายงานการส่งซ่อมครุภัณฑ์_". date("d-m-Y");
?>
