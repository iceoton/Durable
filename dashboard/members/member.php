...
if(isset($_POST['save_member'])){
	...
	if($File_name != NULL){
		...
		$getDB->my_sql_insert("user","user_key='".$member_key."',name='".addslashes($_POST['member_name'])."',lastname='".addslashes($_POST['member_lastname'])."',username='".addslashes($_POST['member_code'])."',password='".md5(addslashes($_POST['member_password']))."',user_photo='".$newfilename."',user_class='1',user_language='th',email='".addslashes($_POST['member_email'])."',user_status='".addslashes($_REQUEST['member_status'])."'");
	}else{
		...
		$getDB->my_sql_insert("user","user_key='".$member_key."',name='".addslashes($_POST['member_name'])."',lastname='".addslashes($_POST['member_lastname'])."',username='".addslashes($_POST['member_code'])."',password='".md5(addslashes($_POST['member_password']))."',user_class='1',user_language='th',email='".addslashes($_POST['member_email'])."',user_status='".addslashes($_REQUEST['member_status'])."'");
	}
...
<!--<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus fa-fw"></i><?php // echo @LA_LB_NEW_MEMBER;?></button><br/><br/>-->
  ...
  $x=0;
	    ...
	    @$getmember = $getDB->my_sql_select(NULL,"member","member_status <> '2' ORDER BY member_insert DESC");
