...
$getdata->my_sql_set_utf8();
	switch(addslashes($_GET['type'])){
		...
		break;
		case "delete_asset_location" : $getdata->my_sql_delete("location","id='".addslashes($_GET['id'])."'");
		break;
		case "delete_asset_source" : $getdata->my_sql_delete("source","id='".addslashes($_GET['id'])."'");
		break;
